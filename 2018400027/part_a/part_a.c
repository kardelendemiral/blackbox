/* Author:    Kardelen Demiral
	...
	Conclusion: We can execute binary files without knowing anything about the source code using parallel programming. 
	The only thing we should know is it's input and output types so that we can capture them. 
